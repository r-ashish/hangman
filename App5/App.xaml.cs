...
namespace App5
{
    ...
    public sealed partial class App : Application
    {
        ...
        {
            var folder = await Windows.Storage.ApplicationData.Current.LocalFolder.CreateFolderAsync("Data",CreationCollisionOption.OpenIfExists);
            var file = await folder.CreateFileAsync("highscore.txt", CreationCollisionOption.OpenIfExists);
            highScore = await FileIO.ReadTextAsync(file);
            if (highScore == "")
            {
